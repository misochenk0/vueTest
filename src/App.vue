    ...
    <div class="todo__body">
      <div class="todo__wrapper">
        ...
        <div class="todo-block" v-if="todoList.length > 0">
          ...
          />
          <TodoInfo :list="todoList" :displayedList="displayedTodos" />
    ...
    todoList: function () {
      ...
      this.filters = this.filters.map((item) => {
        ...
        if (item.type !== "show-all") {
          if (
            this.todoList.every((item) => item.isCompleted === true) ||
            this.todoList.every((item) => item.isCompleted === false)
          ) {
            this.onlyAll = true;
          } else {
            this.onlyAll = false;
          ...
          return {
            ...item,
            isShowed:
              this.todoList.some((item) => item.isCompleted === true) &&
              !this.todoList.every((item) => item.isCompleted === true),
          };
        } else {
          return item;
